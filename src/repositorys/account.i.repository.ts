...
export interface IAccountRepository {
   ...
   createSocialAccount(params: { userId: string; nickname: string; email: string; socialId: string; socialType: string; refreshToken: string; profileUrl: string; termsAgreed: boolean; privacyAgreed: boolean }): Promise<UserInfo>
